...
final class PresentationController: UIPresentationController {
    ...
    init(configuration: DrawerConfiguration, inDebugMode: Bool = false, presented: UIViewController, presenting: UIViewController?) {
...
private extension PresentationController {
    ...
    var drawerPartialH: CGFloat {
        guard let viewController = presentedViewController as? PartiallyExpandableDrawer
            else { return 0 }
        return viewController.heightOfPartiallyExpandedDrawer
    }
